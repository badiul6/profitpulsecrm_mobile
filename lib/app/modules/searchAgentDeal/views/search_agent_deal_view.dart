...
import 'package:profitpulsecrm_mobile/app/modules/searchAgentDeal/controllers/search_agent_deal_controller.dart';

class SearchAgentDealView extends GetView<SearchAgentDealController> {
  const SearchAgentDealView({super.key});
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search by contact details',
  ...
  Widget dealListTab(RxList<AgentDeal> deals, double screenHeight, double screenWidth, ColorScheme colorScheme) {
