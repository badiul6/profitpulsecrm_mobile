...
class CsagentHomeView extends GetView<MainController> {
  CsagentHomeView({super.key});
                          ...
                          children: [
                            Text('Total tickets',
                                style: TextStyle(
                                    ...
                                    fontWeight: FontWeight.w500)),
                            const Spacer(),
                            Text(controller.agentTickets.length.toString(),
                                style: TextStyle(
                                    fontSize: 22,
                                    color: colorScheme.onBackground,
                                    fontWeight: FontWeight.w700)),
