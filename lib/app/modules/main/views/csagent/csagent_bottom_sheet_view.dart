...
class CsagentBottomSheetView extends GetView<MainController> {
  const CsagentBottomSheetView({super.key});
      ...
      child: Column(
        children: [
          ...
          _buildListTile(context,
              icon: Icons.account_box, title: 'Add a contact', onTap: () {
            Navigator.pop(context);
            Get.toNamed(Routes.ADD_CONTACT);
          }),
          const Divider(),
          _buildListTile(context,
              icon: Icons.note_alt, title: 'Create a ticket', onTap: () {
            Navigator.pop(context);
