...
class MagentHomeView extends GetView<MainController> {
  MagentHomeView({super.key});
                                ...
                                Row(
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                            controller.fbCampaign.value!.clicks,
                                            style: TextStyle(
                                                fontSize: 22,
                                                color: colorScheme.background,
                                                fontWeight: FontWeight.w700)),
                            ...
                            child: PageView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return Transform.scale(
                                    ...
                                    child: campaignCard(screenWidth,
                                        screenHeight, colorScheme, index),
                                  );
                                }),
                          )),
                  ],
